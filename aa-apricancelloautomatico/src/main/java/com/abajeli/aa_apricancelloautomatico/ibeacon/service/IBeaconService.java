            ...
            if (service != null) {
                switch (msg.what) {
                    case MSG_START_RANGING:
                        ...
                        service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.abajeli.aa_apricancelloautomatico.ibeacon.service.Callback(msg.replyTo, startRMData.getIntentActionForCallback()));
                        break;
                    ...
                    case MSG_START_MONITORING:
                        ...
                        service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.abajeli.aa_apricancelloautomatico.ibeacon.service.Callback(msg.replyTo, startRMData.getIntentActionForCallback()));
                        break;
    ...
    private class ScanProcessor extends AsyncTask<ScanData, Void, Void> {
        ...
        protected Void doInBackground(ScanData... params) {
            ...
            if (iBeacon != null) {
                ...
                if (iBeacon.getProximity() < 2){
                    Log.d(TAG, "iBeacon calling server fot open commang");

                    BTMain btMain=new BTMain();
                    //btMain.startCommunication();
                    //MainActivity.openGate();
                    try {
                        Thread.sleep(15000, 00);
                    }catch(Exception e){
